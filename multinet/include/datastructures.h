...
namespace mlnet {
    ...
    public:
        ...
        /**
         * Creates an empty clique and returns a pointer to it.
         * @return a pointer to the new multilayer network
         */
        static CliqueSharedPtr create();
        static CliqueSharedPtr create(const hash_set<ActorSharedPtr>& actors, const hash_set<LayerSharedPtr>& layers);
